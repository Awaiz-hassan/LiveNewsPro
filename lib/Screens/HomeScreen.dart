      ...
      body: Stack(
        children: [
          ...
          Align(
            alignment: Alignment.topRight,
            child: Container(
              margin: EdgeInsets.only(top: 55, right: 55),
              child: Material(
                clipBehavior: Clip.antiAlias,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "Watch Your",
                    style: TextStyle(color: AppTheme.purple, fontSize: 27.0),
                  ),
                  Text(
                    "News Channels",
                    style: TextStyle(
          ...
          Align(
            child: Container(
                            ...
                            return GestureDetector(
                                ...
                                onTap: (){
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => LiveStreamScreen(_channelsController.channelList[index])));
                                },
                                child:
                                Container(
                              height: 57,
              ...
              margin: const EdgeInsets.only(top: 90.0, bottom: 15.0),
            ),
          )
        ],
      ),
